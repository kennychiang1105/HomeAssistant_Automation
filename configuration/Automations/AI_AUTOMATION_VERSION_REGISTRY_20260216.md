...
| `configuration/Automations/08-5G書房燈感應AI.yaml` | `08-5G 書房燈感應AI (V3.0)` | `ai_08_5g_study_motion_light` | `V3.0` |
...
| `configuration/Automations/104-1車庫鐵門感應燈AI.yaml` | `104-1車庫鐵門感應燈AI (V3.0)` | `ai_104_1_garage_gate_motion_light` | `V3.0` |
| `configuration/Automations/104-3鐵門判斷未關提醒及作動AI.yaml` | `104-3鐵門判斷未關提醒及作動AI (V3.0)` | `ai_104_3_garage_gate_open_guard_and_autoclose` | `V3.0` |
