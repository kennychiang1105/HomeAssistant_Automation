...
| `configuration/Automations/03苗栗天氣告知系統AI.yaml` | `03苗栗天氣告知系統AI (V3.1)` | `ai_miaoli_weather_disaster_notify` | `V3.1` |
...
| `configuration/Automations/08-5G書房燈感應AI.yaml` | `08-5G 書房燈感應AI (V3.0)` | `ai_08_5g_study_motion_light` | `V3.1` |
