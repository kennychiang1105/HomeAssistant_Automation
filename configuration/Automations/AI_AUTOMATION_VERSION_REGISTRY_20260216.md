...
| `configuration/Automations/08-5G書房燈感應AI.yaml` | `08-5G 書房燈感應` | `ai_08_5g_study_motion_light` | `V3.0` |
| `configuration/Automations/08-8A廚房感應燈AI.yaml` | `08-8A 廚房感應燈開` | `ai_08_8a_kitchen_motion_light` | `V3.0` |
